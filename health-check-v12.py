...
from serverauthenticationmode import SECURITY_SCRIPT17_BASE64
...
##
    ...
    def group_dataframe(self,summary_df):
        try:
            ...
            """
            group_mapping = {
                "SQL Server Configuration": ["Storage", "ServiceAccountPermission", "PermissionResults", "BuiltinAdmin",
                                             "SQLServerAuthentication", "ExpensiveQueries", "WaitStats", "MaxMemory",
                ...
                "Security": ["HighPriviligeLogin", "EmptyPasswordLogins", "SamePasswordLogins",
                             "PolicyNotCheckedLogins", "ServerLogins", "DisableLogins", "CPU", "ServiceAccount",
                             "ServiceAccountPermission", "SaAccount", "BUILTINAdministratorsGroup", "OrphanUser",
